      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-slate-600 rounded text-white placeholder-slate-500 focus:outline-none focus:border-blue-500"
          />
        </div>
        ...
        {onCreateNew && (
          <button
            onClick={onCreateNew}
            className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors whitespace-nowrap"
          >
            + New Report
          </button>
        )}
        ...
        {sortedReports.length === 0 ? (
          ...
          sortedReports.map(report => (
            <button
              ...
              className="w-full text-left bg-slate-900 border border-slate-700 hover:border-slate-600 rounded-lg p-4 transition-all hover:shadow-lg hover:shadow-blue-500/10 group"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs text-slate-400">{report.entityName}</span>
                  </div>
